                    ...
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h5 class="font-15">O'qtuvchilar</h5>
{{--                          <!-- <h2 class="mb-3 font-18">{{$oqtuvchi_count}}</h2> -->--}}
                          <p class="mb-0"><span class="col-green">10%</span> Increase</p>
                        </div>
                      </div>
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <img src="https://media.istockphoto.com/id/846818776/vector/young-male-teacher-is-writing-chalk-on-a-school-blackboard.jpg?s=612x612&w=0&k=20&c=cck-P3BHefU2uNrSfbAuw7fBp_M1uqaa7ghIqitgZPM=" alt="">
                        </div>
                      </div>
                    </div>
                  </div>
...
{{--                          <!-- <h2 class="mb-3 font-18">{{$oquvchilar_count}}</h2> -->--}}
                          <p class="mb-0"><span class="col-orange">50%</span> Decrease</p>
                        </div>
                      </div>
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <img src="https://static.vecteezy.com/system/resources/previews/014/831/139/non_2x/students-trying-to-find-thinking-about-the-operation-written-on-the-classroom-board-vector.jpg" alt="">
                        </div>
                      </div>
                    </div>
                  </div>
...
{{--                          <!-- <h2 class="mb-3 font-18">{{$kurslars_count}}</h2> -->--}}
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTWGlxD3arxZ4pdqowTT1X1Ib3O4-mCrv0Ej_mkXpBfS-h3z9VcdH3RGhf71sNg11dC-VU&usqp=CAU" alt="" style="margin: 0.5rem 0" >
                        </div>
                      </div>
                    </div>
                  </div>
